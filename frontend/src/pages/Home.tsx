    ...
    <div className="container mx-auto px-4 py-8 pt-20 h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 col-span-1">
          <h2 className="text-lg font-bold text-gray-800 mb-4">Task Summary</h2>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 col-span-1">
          ...
          {Object.keys(dashboardData.pendingPointsPerProject).length > 0 ? (
                  ...
                  <div key={project}>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            points > 0 ? Math.min((points / 200) * 100, 100) : 0
                          }%`,
                        }}
                      ></div>
                    </div>
            ...
            <p className="text-gray-500 text-center py-4">No pending points</p>
          )}
        </div>
      </div>
